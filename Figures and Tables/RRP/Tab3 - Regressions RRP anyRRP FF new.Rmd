...
<!-- # Logistic model (Any RRP) -->
<!-- ```{r} -->
<!-- d50 %>%  -->
<!--   map(glm, formula = RRP_1 ~ SciNorms + PeerNorms + WorkPress + PubPress + FundPress + Competitive + DetectCol + DetectRev + Mentoring + OrgJust + Field + Rank + Gender + Research + Support,  -->
